...
class DataGenerator(keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        embavg, pos1, pos2, super = self.__data_generation(list_IDs_tmp)

        return embavg, [keras.utils.to_categorical(pos1, num_classes=self.n_pos1_classes),\
