...
outputfile = 'pos.txt'
beta = 1.0
modelfile = 'small_pos.h5'

try:
    opts, args = getopt.getopt(sys.argv[1:],"hbiom",["beta=","input=","output=","model="])
except getopt.GetoptError as err:
    print(str(err))
    print("pos2.py -b <beta_value> -i <inputfile> -o <outputfile> -m <modelfile>")
...
os.chdir('/Users/moot/checkout/DeepGrail/best_pos')   
