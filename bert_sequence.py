...
class DataGenerator(keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        bert, pos1, pos2, super = self.__data_generation(list_IDs_tmp)


        return bert, [keras.utils.to_categorical(pos1, num_classes=self.n_pos1_classes),\
