...
class DyerLSTMCell(Layer):
    ...
    def __init__(self, units,
                 ...
                 implementation=1,
                 **kwargs):
        super(DyerLSTMCell, self).__init__(**kwargs)
        self.units = units
    ...
    def build(self, input_shape):
        ...
        self.recurrent_kernel_cf = self.recurrent_kernel[:, self.units * 3: self.units * 4]
        self.recurrent_kernel_co = self.recurrent_kernel[:, self.units * 4:]
    ...
    def call(self, inputs, states, training=None):
        ...
        if self.implementation == 1:
            ...
            if 0 < self.recurrent_dropout < 1.:
                ...
                h_tm1_cf = h_tm1 * rec_dp_mask[4]
                h_tm1_co = h_tm1 * rec_dp_mask[3]
            else:
                h_tm1_f = h_tm1
                h_tm1_c = h_tm1
                h_tm1_o = h_tm1
            ...
            c = (f * c_tm1) + ((1-f) * self.activation(x_c + K.dot(h_tm1_c,
            ...
            c = f * c_tm1 + i * self.activation(z1)
    ...
    def get_config(self):
        ...
        base_config = super(DyerLSTMCell, self).get_config()
...
class DyerLSTM(RNN):
    ...
    def __init__(self, units,
        ...
        super(DyerLSTM, self).__init__(cell,
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        ...
        return super(DyerLSTM, self).call(inputs,
                                      mask=mask,
                                      training=training,
    ...
    def get_config(self):
        config = {'units': self.units,
                  ...
                  'recurrent_dropout': self.recurrent_dropout,
                  'implementation': self.implementation}
        base_config = super(DyerLSTM, self).get_config()
