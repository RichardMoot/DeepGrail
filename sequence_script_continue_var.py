...
checkpoint = ModelCheckpoint(best_file, monitor='val_time_distributed_9_accuracy', verbose=1, save_best_only=True, save_weights_only=False, mode='max')

save_current = ModelCheckpoint(current_file, monitor='val_time_distributed_9_accuracy', verbose=1, save_best_only=False, save_weights_only=False, mode='auto', save_freq="epoch")
